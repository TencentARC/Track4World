...
from .._helpers import no_warnings, timeit
from .utils import max_pool_2d, sliding_window, pooling, lite_sum, lite_prod, lite_dot, lite_norm, image_uv
...
def depth_map_to_normal_map(depth: ndarray, intrinsics: ndarray, mask: ndarray = None, edge_threshold: float = None, use_ray: bool = False) -> ndarray:
    ...
    ## Returns
        normal (ndarray): shape (height, width, 3), normal map. 
    """
    points = depth_map_to_point_map(depth, intrinsics, use_ray=use_ray)
