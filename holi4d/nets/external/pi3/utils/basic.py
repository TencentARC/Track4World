...
def load_images_as_tensor(path='data/truck', interval=1, PIXEL_LIMIT=255000):
    ...
    # ✅ Case 1: path is a list of image paths
    ...
    # ✅ Case 3: path is a video
        ...
        raise ValueError(f"Unsupported path type: {path}. Must be a list, directory, or .mp4 file.")
